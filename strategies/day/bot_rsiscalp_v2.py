#!/usr/bin/env python3
"""bot_rsiscalp_v2.py — RSI-Scalp +Trend v2 (gap-firmness filter).
...
# ─── Logging ───
log = logging.getLogger("bot_rsiscalp_v2")
...
def main():
    ...
    write_status({
        "env": os.environ.get("RSISCALP_DATA_DIR", "paper_rsiscalp_trend_v2"),
