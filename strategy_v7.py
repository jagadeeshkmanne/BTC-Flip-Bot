"""
strategy_v7.py — V7: V6 + Pyramiding (add to winners at +3R)  ◀ EXPERIMENTAL

V7 adds pyramiding: when a trade reaches +3R favorable, add 50% more position size.
This amplifies fat-tail winners without adding more entry signals.
