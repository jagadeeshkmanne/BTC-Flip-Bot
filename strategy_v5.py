"""
strategy_mtf_candles.py — MTF Candlestick Flip Bot (proven configuration).

Rebuilt from the only configuration in this session that produced HONEST positive
CAGR (+7.7% with maker, ~+1% with taker, -27% DD, PF 1.51).
...
USE_PARTIAL_TP    = True
PARTIAL_TP_R      = 6.0          # only fires on HUGE winners — lock 30% at +6R
